...
# Temperature value
label3 = customtkinter.CTkLabel(ScreenTwo,font=font2, anchor=E, text=str(getTemp())+"°F")
...
# Humidity values
label6 = customtkinter.CTkLabel(ScreenTwo,font=font2, anchor=E, text=getHumid())
